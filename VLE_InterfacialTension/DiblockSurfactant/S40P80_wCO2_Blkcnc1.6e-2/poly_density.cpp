...
//    exit(-1);
    ...
    tmpTNsp = TNsp-2;
    for (i=0;i<tmpTNsp;i++) /*Loop over Molecules other than the Surfactant:Here Polyol+CO2*/
    {
#pragma omp parallel for private(k,nn)
  ...
  /*For Surfactant*/
    ...
    for (i=0;i<tmpTNsp;i++) /*Loop over Molecules other than the surfactant:Here Polyol and CO2*/
    {
