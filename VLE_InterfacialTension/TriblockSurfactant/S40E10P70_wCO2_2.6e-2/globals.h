...
extern
#endif
double Xa,Xb,*Xar,*Xbr,**wwall,**q_pgt,**qs_fwd_pgt,**qs_bkd_pgt,**nwrhok,**wk,**extwk,amu[TNsp],**wn0,**wn1,**wn2,**wn3,***wnv1,***wnv2,**knltz1,**knlt1,**kntz1,rf_len,Adisp[7][3],Bdisp[7][3],Lh[Dim],L[Dim],dx[Dim],Lknl[Dim],dxknl[Dim],Tmpr,kijpara[crsTNsp][2],epsln[TNsp],crsepsln[crsTNsp],sigma[TNsp],rsigma3[TNsp],rsigma[TNsp],Nsig[TNsp],N2sig[TNsp], blkrho[TNsp][2],**rhoK, **dfloc,**extdflocdn0,**extdflocdn3,**extrhok2,*extz,**extrhok,**qk,**tmpN2,**tmpNhf,**extqk,*qtmp,*extqtmp,*tmpar1,*exttmpar1,lamb,tmp_lamb,**dfchdn3,**dfhsdn3,**dfttdrho,**dfdispndr,**dfdispl2dn0,**dfdispl2dn3,**dfdispl1dn0,**dfdispl1dn3,*ttF,*Fhs,*Fch, *Fdispl1,*Fdispl2, *Fdispnl,prev_dif;
